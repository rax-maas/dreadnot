...
// Hacky Authentication Middleware
...
exports.registerPrivate = function(baton, app) {
  app.get('/', authed, baton.webHandlers.getStacks.bind(baton.webHandlers));
  app.get('/logout', authed, baton.webHandlers.logout.bind(baton.webHandlers));
  app.get('/stacks/:stack/regions/:region', authed, baton.webHandlers.getDeployments.bind(baton.webHandlers));
  app.get('/stacks/:stack/regions/:region/deployments/:deployment', authed, baton.webHandlers.getDeployment.bind(baton.webHandlers));
  app.post('/stacks/:stack/regions/:region/deploy', authed, baton.webHandlers.deploy.bind(baton.webHandlers));
};
