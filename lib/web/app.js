...
exports.registerPrivate = function(baton, app) {
  ...
  app.get('/warning', writeAuth, baton.webHandlers.getWarning.bind(baton.webHandlers));
  app.post('/warning', writeAuth, baton.webHandlers.saveWarning.bind(baton.webHandlers));
};
