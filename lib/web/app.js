...
exports.registerAPI = function(dreadnot, authdb) {
  ...
  // Register handlers
  app.get('/1.0/', basic, apiHandlers.getStacks);
  app.get('/1.0/stacks/:stack/regions/:region', basic, apiHandlers.getDeployments);
  app.post('/1.0/stacks/:stack/regions/:region', basic, apiHandlers.deploy);
  ...
  app.post('/1.0/warning', basic, apiHandlers.saveWarning);
